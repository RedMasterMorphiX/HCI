...
class Ui_Editor(object):
    def setupUi(self, Editor):
        ...
        self.chatbot_frame = QtWidgets.QFrame(self.centralwidget)
...
"color: rgb(255, 255, 255);")
        ...
        self.horizontalLayout_2.addWidget(self.chatbot_frame)
        ...
        self.menuDisplay_Mode = QtWidgets.QMenu(self.menubar)
        ...
        self.actionRead_out = QtWidgets.QAction(Editor)
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/img/resources/imgs/voice.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRead_out.setIcon(icon31)
        self.actionRead_out.setObjectName("actionRead_out")
        self.actionMobile_2 = QtWidgets.QAction(Editor)
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/img/resources/imgs/Mobile.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionMobile_2.setIcon(icon32)
        self.actionMobile_2.setObjectName("actionMobile_2")
        self.actionTablet_2 = QtWidgets.QAction(Editor)
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/img/resources/imgs/Tablet.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionTablet_2.setIcon(icon33)
        self.actionTablet_2.setObjectName("actionTablet_2")
        self.actionDesktop_2 = QtWidgets.QAction(Editor)
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(":/img/resources/imgs/Desktop.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDesktop_2.setIcon(icon34)
        self.actionDesktop_2.setObjectName("actionDesktop_2")
        self.actionSpeech_to_Text = QtWidgets.QAction(Editor)

        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(":/img/resources/imgs/speech-to-text2-1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSpeech_to_Text.setIcon(icon35)
        self.actionSpeech_to_Text.setObjectName("actionSpeech_to_Text")
        ...
        self.menuDisplay_Mode.addAction(self.actionMobile_2)
        self.menuDisplay_Mode.addAction(self.actionTablet_2)
        self.menuDisplay_Mode.addAction(self.actionDesktop_2)
        self.menubar.addAction(self.menuDisplay_Mode.menuAction())
        ...
        self.toolBar.addAction(self.actionRead_out)
        ...
        self.toolBar.addAction(self.actionSpeech_to_Text)

        

         # Connect display actions to resize method
        self.actionMobile_2.triggered.connect(lambda: self.change_display(Editor, "mobile"))
        self.actionTablet_2.triggered.connect(lambda: self.change_display(Editor, "tablet"))
        self.actionDesktop_2.triggered.connect(lambda: self.change_display(Editor, "desktop"))
    ...
    def retranslateUi(self, Editor):
        ...
        self.menuDisplay_Mode.setTitle(_translate("Editor", "Display Mode▼"))
        ...
        self.actionRead_out.setText(_translate("Editor", "Read out"))
        self.actionRead_out.setToolTip(_translate("Editor", "read the text"))
        self.actionMobile_2.setText(_translate("Editor", "Mobile"))
        self.actionMobile_2.setToolTip(_translate("Editor", "mobile display"))
        self.actionTablet_2.setText(_translate("Editor", "Tablet"))
        self.actionTablet_2.setToolTip(_translate("Editor", "tablet display"))
        self.actionDesktop_2.setText(_translate("Editor", "Desktop"))
        self.actionDesktop_2.setToolTip(_translate("Editor", "Desktop display"))
        self.actionSpeech_to_Text.setText(_translate("Editor", "Speech to Text"))
        self.actionSpeech_to_Text.setToolTip(_translate("Editor", "speech to text"))

    def change_display(self, Editor, mode):
        """Adjust window size based on the selected display mode."""
        if mode == "mobile":
            Editor.resize(500, 800)  # Mobile size
        elif mode == "tablet":
            Editor.resize(800, 950)  # Tablet size
        else:
            Editor.resize(1900, 1000)  # Desktop size
